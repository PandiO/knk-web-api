    ...
    public class PermissionMappingProfile : Profile
    {
        public PermissionMappingProfile()
        {
            CreateMap<PermissionGroup, PermissionGroupDto>()
                ...
                .ForMember(dest => dest.SalaryMultiplier, src => src.MapFrom(src => src.SalaryMultiplier))
                .ForMember(dest => dest.GemBonusMultiplier, src => src.MapFrom(src => (decimal?)src.GemBonusMultiplier))
                .ForMember(dest => dest.ExpBonusMultiplier, src => src.MapFrom(src => (decimal?)src.ExpBonusMultiplier))
                ...
                .ForMember(dest => dest.ChatPrimaryColor, src => src.MapFrom(src => src.ChatPrimaryColor))
                .ForMember(dest => dest.ChatSecondaryColor, src => src.MapFrom(src => src.ChatSecondaryColor))
                .ForMember(dest => dest.NameColor, src => src.MapFrom(src => src.NameColor))
            ...
            CreateMap<PermissionGroupDto, PermissionGroup>()
                ...
                .ForMember(dest => dest.IsPremiumTier, src => src.MapFrom(src => src.IsPremiumTier))
                .ForMember(dest => dest.SalaryMultiplier, src => src.MapFrom(src => src.SalaryMultiplier))
                .ForMember(dest => dest.GemBonusMultiplier, src => src.MapFrom(src => src.GemBonusMultiplier ?? 1.0m))
                .ForMember(dest => dest.ExpBonusMultiplier, src => src.MapFrom(src => src.ExpBonusMultiplier ?? 1.0m))
                .ForMember(dest => dest.ChatPrefix, src => src.MapFrom(src => src.ChatPrefix))
                .ForMember(dest => dest.ChatSuffix, src => src.MapFrom(src => src.ChatSuffix))
                .ForMember(dest => dest.ChatPrimaryColor, src => src.MapFrom(src => src.ChatPrimaryColor))
                .ForMember(dest => dest.ChatSecondaryColor, src => src.MapFrom(src => src.ChatSecondaryColor))
            ...
            CreateMap<PermissionGroup, PermissionGroupListDto>()
                ...
                .ForMember(dest => dest.isPremiumTier, src => src.MapFrom(src => src.IsPremiumTier))
                .ForMember(dest => dest.salaryMultiplier, src => src.MapFrom(src => src.SalaryMultiplier))
                .ForMember(dest => dest.gemBonusMultiplier, src => src.MapFrom(src => src.GemBonusMultiplier))
                .ForMember(dest => dest.expBonusMultiplier, src => src.MapFrom(src => src.ExpBonusMultiplier))
                .ForMember(dest => dest.chatPrimaryColor, src => src.MapFrom(src => src.ChatPrimaryColor))
                .ForMember(dest => dest.chatSecondaryColor, src => src.MapFrom(src => src.ChatSecondaryColor))
                .ForMember(dest => dest.nameColor, src => src.MapFrom(src => src.NameColor))
                .ForMember(dest => dest.parentGroupId, src => src.MapFrom(src => src.ParentGroupId))
