    ...
    public class GateDoorMappingProfile : Profile
    {
        public GateDoorMappingProfile()
        {
            ...
            CreateMap<GateDoor, GateDoorDto>()
                ...
                .ForMember(dest => dest.ClosedRegionData, opt => opt.MapFrom(src => src.ClosedRegionData))
                .ForMember(dest => dest.OpenedRegionData, opt => opt.MapFrom(src => src.OpenedRegionData))
            ...
            CreateMap<GateDoorDto, GateDoor>()
                ...
                .ForMember(dest => dest.ClosedRegionData, opt => opt.MapFrom(src => src.ClosedRegionData ?? string.Empty))
                .ForMember(dest => dest.OpenedRegionData, opt => opt.MapFrom(src => src.OpenedRegionData ?? string.Empty))
