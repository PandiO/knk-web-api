...
namespace knkwebapi_v2.Migrations
{
    ...
    [Migration("20260926161448_AddCurrencyLedgerImmutabilityTriggers")]
    partial class AddCurrencyLedgerImmutabilityTriggers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("knkwebapi_v2.Models.Grade", b =>
                {
                    ...
                    b.Property<int?>("EnchantLevelCapDivisor")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("knkwebapi_v2.Models.Kit", b =>
                {
                    ...
                    b.Property<bool>("GrantOnFirstJoin")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("IsSinglePurchasePremium")
                        .HasColumnType("tinyint(1)");

                    b.Property<int?>("LeggingsId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PremiumPriceGems")
                        .HasColumnType("int");

                    b.Property<int?>("RequiredPermissionGroupId")
                        .HasColumnType("int");

                    b.Property<string>("RequiredPermissionNode")
                        .HasColumnType("longtext");
                    ...
                    b.HasIndex("RequiredPermissionGroupId");
            ...
            modelBuilder.Entity("knkwebapi_v2.Models.KitClaim", b =>
                {
                    ...
                    b.HasIndex("KitId", "UserId", "ClaimedAt");

                    b.ToTable("kit_claims", (string)null);
                });

            modelBuilder.Entity("knkwebapi_v2.Models.KitContent", b =>
                {
                    b.Property<int>("KitId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("KitId", "SlotIndex");

                    b.HasIndex("ItemBlueprintId");

                    b.ToTable("kit_contents", (string)null);
                });

            modelBuilder.Entity("knkwebapi_v2.Models.KitPurchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("knkwebapi_v2.Models.MenuTemplate", b =>
                {
                    ...
                    b.Property<string>("BackgroundMaterial")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
            ...
            modelBuilder.Entity("knkwebapi_v2.Models.SalaryConfiguration", b =>
                {
                    ...
                    b.Property<int>("OfflinePayoutMaxHours")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("knkwebapi_v2.Models.PermissionGroup", b =>
                {
                    ...
                    b.Property<string>("ChatPrimaryColor")
                        .HasMaxLength(32)
                        .HasColumnType("varchar(32)");

                    b.Property<string>("ChatSecondaryColor")
                        .HasMaxLength(32)
                        .HasColumnType("varchar(32)");
            ...
            modelBuilder.Entity("knkwebapi_v2.Models.Kit", b =>
                {
                    ...
                    b.HasOne("knkwebapi_v2.Models.ItemBlueprint", "Chestplate")
                        .WithMany()
                        .HasForeignKey("ChestplateId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("knkwebapi_v2.Models.ItemBlueprint", "Hand")
                        .WithMany()
                        .HasForeignKey("HandId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("knkwebapi_v2.Models.ItemBlueprint", "Helmet")
                        .WithMany()
                        .HasForeignKey("HelmetId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("knkwebapi_v2.Models.ItemBlueprint", "Leggings")
                        .WithMany()
                    ...
                    b.HasOne("knkwebapi_v2.Models.PermissionGroup", "RequiredPermissionGroup")
                        .WithMany()
                        .HasForeignKey("RequiredPermissionGroupId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("knkwebapi_v2.Models.ItemBlueprint", "Shield")
                        .WithMany()
                    ...
                    b.Navigation("RequiredPermissionGroup");
            ...
            modelBuilder.Entity("knkwebapi_v2.Models.MenuTemplate", b =>
                {
                    b.HasOne("knkwebapi_v2.Models.MinecraftMaterialRef", "BackgroundMaterialRef")
                        .WithMany()
                        .HasForeignKey("BackgroundMaterialRefId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("BackgroundMaterialRef");
                });
