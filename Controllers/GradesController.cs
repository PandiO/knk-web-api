    ...
    public class GradesController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] GradeCreateDto dto)
        {
            ...
            try
            {
                ...
                return CreatedAtRoute("GetGradeById", new { id = created.Id }, created);
            }
        ...
        [HttpPost("search")]
        public async Task<ActionResult<PagedResultDto<GradeListDto>>> Search([FromBody] PagedQueryDto query)
        {
